...
class ResidualBlock_test(nn.Module):
    def __init__(self, d_latent: int, in_features: int, out_features: int):
        ...
        * `out_features` is the number of features in the output feature map
        ...
        # First [style block](#style_block) changes the feature map size to `out_features`
        self.style_block1 = StyleBlock_test(d_latent, in_features, out_features)
        # Second [style block](#style_block)
        self.style_block2 = StyleBlock_test(d_latent, out_features, out_features)
...
class StyleBlock_test(nn.Module):
    """
    <a id="style_block"></a>
    ...
    def __init__(self, d_latent: int, in_features: int, out_features: int):
        ...
        * `out_features` is the number of features in the output feature map
        ...
        self.to_style = nn.Linear(d_latent, in_features, bias=1.0)
        # Weight modulated convolution layer
